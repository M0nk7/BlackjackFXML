...
public class Deck {
	...
	private Suit cradSuit[] = new Suit[10];
        private Value cradValue[] = new Value[10];
        private int numSuit = 0;
...
//                this.addCradSuit(comingFrom.getCradSuit(0));
//                this.addCradValue(comingFrom.getCradValue(0));
	...
	public void addCradSuit(Suit suit)
        {
            this.cradSuit[numSuit] =  suit;
        }
        public void addCradValue(Value value)
        {
            this.cradValue[numValue] = value;
        }
	public Suit getCradSuit(int i)
        {
            return this.cards.get(i).getSuit();
        }
        public Value getCradValue(int i)
        {
